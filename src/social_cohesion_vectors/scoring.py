...
_AUTONOMY_RISK = (
    ...
    r"\bpress(?:es|ed|ing)?\b.{0,48}\b(?:to|into)\b",
    r"\bpressure\b.{0,48}\b(?:to|into)\b",
    ...
    r"\bblackmail\b",
    r"\bless room to\b",
    r"\bobject, check details, or leave\b",
    r"\btreats silence or hesitation as agreement\b",
    ...
    r"\bafter all (?:we|the group) (?:did|has done)\b",
